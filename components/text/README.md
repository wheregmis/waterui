...
The crate is designed around reactive primitives, automatically updating text when underlying data changes. All text rendering delegates to native platform widgets (SwiftUI on Apple, Jetpack Compose on Android), ensuring platform-native appearance and accessibility.
