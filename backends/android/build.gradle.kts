...
android {
    ...
    compileSdk = 34 // TODO: Confirm compile SDK level with project requirements

    defaultConfig {
        minSdk = 24 // TODO: Align with supported Android targets
        targetSdk = 34 // TODO: Keep in sync with compileSdk once finalised
